  ...
  function student_profile($student_id)
  {
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if (html_escape($this->input->post('description')) != null) {
        ...
        if(!empty($books)) {
            foreach ($books as $row) {
                if ($row->file_name == null)
                    ...
                    $download = '<a href="'.base_url("uploads/document/$row->file_name").'" class="btn btn-blue btn-icon icon-left"><i class="entypo-download"></i>'.get_phrase('download').'</a>';
